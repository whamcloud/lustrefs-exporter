...
pub enum TargetStats {
    ...
    RecoveryLastTransno(TargetStat<u64>),
    RecoveryQueuedRequests(TargetStat<u64>),
    RecoveryReplayedRequests(TargetStat<u64>),
    RecoveryRequestedReplayClients(TargetStat<u64>),
    RecoveryStatus(TargetStat<RecoveryStatus>),
    RecoveryStart(TargetStat<u64>),
    RecoveryStartTime(TargetStat<u64>),
